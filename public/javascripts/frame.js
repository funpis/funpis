    ...
    var $div_item_foot = $('<div>',
        {
            ...
            html: '<div class="item_foot_left">' +
                    '<div class="div_hover_click"><img src="http://192.168.91.197:3000/images/24/heart1.png" alt="LIKE" title="LIKE" /></div>' +
                    '<div class="div_left_margin" style="font-size:1.5em;">9999</div>' +
                  '</div>' + 
                  '<div class="item_foot_right">' +
                    '<div class="div_hover_click div_left_margin"><img src="http://192.168.91.197:3000/images/24/channel.png" alt="CHANNEL" title="SERIAL" /></div>' +
                    '<div class="div_hover_click div_left_margin"><img src="http://192.168.91.197:3000/images/24/download.png" alt="DOWNLOAD" title="DOWNLOAD" /></div>' +
                    '<div class="div_hover_click div_left_margin"><img src="http://192.168.91.197:3000/images/24/forward.png" alt="FORWARD" title="FORWARD" /></div>' +
                  '</div>'
        });
